...
<div class="container mt-5">
    <h2 class="text-center">Animal Sounds</h2>
...
<script>
    ...
    function displayAnimals() {
        animals.forEach(animal => {
            ...
            animalImage.src = 'games/images/' + animal.image; // Adjust the image path as needed
    ...
    function playSound(animal) {
        ...
        // Play the new audio
        currentAudio = new Audio('games/sounds/' + animal.animal_sound);
        currentAudio.play();
    ...
    function displayAnimalFacts() {
        ...
        facts.forEach(fact => {
            ...
            factCard.innerHTML = `<h4>${fact.name}</h4>
                                  <img src='games/images/${fact.image}' alt='${fact.name}' class='fact-image' />
